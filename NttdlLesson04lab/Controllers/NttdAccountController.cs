...
using NttdlLesson04lab.Models;

namespace NttdlLesson04lab.Controllers
{
    public class NttdAccountController : Controller
    {
        private readonly List<NttdAccount> NttdAccounts = new()
        {
            new NttdAccount
            {
                Id = 1,
        ...
        {
            ViewBag.NttdAccounts = NttdAccounts;
            return View();
        }
        [Route("ho-so-cua-toi", Name = "Nttdprofile")]
        public IActionResult NttdProfile(int? id)

        {
            NttdAccount NttdAccount = new NttdAccount
            {
                Id = 5,
                Name = "Hoàng Quốc Dũng",
                Email = "dung.hoang@example.com",
            ...
            if (id != null)
                NttdAccount = NttdAccounts.FirstOrDefault(x => x.Id == id);

            ViewBag.NttdAccount = NttdAccount;
            return View();
        }
    }
}
